...
$(".content").length && (contentPadding = parseInt($(".content").css("padding-bottom").replace("px", ""))), $(window).on("scroll", function () {
    ...
    function b(f, g, i, m) {
        ...
        function q() {
            B.$holder.on({keydown: u, "focus.toOpen": t, blur: function () {
    ...
    function c(a, b) {
        ...
        }(c.item.disable), c.set("min", b.min).set("max", b.max).set("now"), g ? c.set("select", g, {format: h, defaultValue: !0}) : c.set("select", null).set("highlight", c.item.now), c.key = {40: 7, 38: -7, 39: function () {
            return i() ? -1 : 1
        }, 37: function () {
            return i() ? 1 : -1
        }, go: function (a) {
...
$(".datepicker-adv-default").each(function (a) {
    var b = $(this).pickadate({clear: "Cancel", close: "OK", closeOnSelect: !1, container: "body", format: "d/m/yyyy", klass: {buttonClear: "btn btn-flat btn-alt picker__button--clear", buttonClose: "btn btn-flat btn-alt picker__button--close", buttonToday: "btn btn-flat btn-alt picker__button--today", navPrev: "icon picker__nav--prev", navNext: "icon picker__nav--next"}, weekdaysFull: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], weekdaysShort: ["S", "M", "T", "W", "T", "F", "S"]}), c = b.pickadate("picker");
    c.on({close: function () {
        $(document.activeElement).blur()
    }, open: function () {
        $(".picker__date-display", c.$root).length || datepickerDateDisplay(c, "highlight")
    }, render: function () {
        null === c.get("select") ? datepickerDateDisplay(c) : datepickerDateDisplay(c, "select")
    }})
}), datepickerDateDisplay = function (a, b) {
    void 0 !== b && (pickerDisplayD = a.get(b, "d"), pickerDisplayM = a.get(b, "mmm"), pickerDisplayW = a.get(b, "dddd"), pickerDisplayY = a.get(b, "yyyy")), $(".picker__box", a.$root).prepend('<div class="picker__date-display"><div class="picker__date-display-top"><span class="picker__year-display">' + pickerDisplayY + '</span></div><div class="picker__date-display-bottom"><span class="picker__weekday-display">' + pickerDisplayW + '</span><span class="picker__day-display">' + pickerDisplayD + '</span><span class="picker__month-display">' + pickerDisplayM + "</span></div></div>")
...
$('[data-toggle="toast"]').tooltip({animation: !1, container: ".toast", html: !0, placement: "bottom", template: '<div class="tooltip"><div class="toast-inner tooltip-inner"></div></div>', trigger: "manual"}), $(document).on("click", '[data-dismiss="toast"]', function (a) {
...
}), Waves.displayEffect({duration: 900}), WebFontConfig = {classes: !1, google: {families: ["Roboto:300,300italic,400,400italic,700,700italic"]}, active: function () {
    ...
    //a.src = ("https:" == document.location.protocol ? "https" : "http") + "webfont.js", a.type = "text/javascript", a.async = "true";
    // modify by tjx
    // 为了配置django的使用,暂时改成如下
    a.src = "../static/js/webfont.js", a.type = "text/javascript", a.async = "true";
